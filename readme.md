...
Beskriv kort:
- hvordan nettsiden ivaretar (eller ikke ivaretar) universell utforming  
- hvordan nettsiden forholder seg til personvern (for eksempel informasjonsplikt, samtykke eller bruk av skjema)
...
Bruk wireframen som utgangspunkt og lag:
- enten en enkel prototype
...
### 5. Versjonskontroll
Alt arbeid skal ligge i GitHub-repoet:
- bruk commit-meldinger som forklarer hva som er gjort
- strukturér filer og mapper på en ryddig måte
